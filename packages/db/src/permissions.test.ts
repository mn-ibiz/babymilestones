...
const EXPECTED: ReadonlyArray<{ role: string; action: string; resource: string }> = [
  ...
  { role: "reception", action: "read", resource: "product" },
  ...
  { role: "cashier", action: "read", resource: "product" },
  { role: "packer", action: "read", resource: "service" },
  { role: "packer", action: "read", resource: "receipt" },
  { role: "packer", action: "read", resource: "product" },
  ...
  { role: "admin", action: "manage", resource: "wallet" },
