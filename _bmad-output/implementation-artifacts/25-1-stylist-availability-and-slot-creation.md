...
- [ ] Task 1: Implement Stylist availability and slot creation (AC: #1, #2, #3)
  - [ ] Satisfy AC#1: `staff_availability` table: staff_id, day_of_week, start_time, end_time, effective_date_range.
  - [ ] Satisfy AC#2: Slots generated nightly into `salon_slots` from staff availability × salon service durations.
  - [ ] Satisfy AC#3: Past/today edits don't retroactively change historical bookings.
- [ ] Task 2: Tests (AC: all)
