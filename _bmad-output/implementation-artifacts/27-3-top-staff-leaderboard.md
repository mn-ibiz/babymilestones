...
- [ ] Task 1: Implement Top-staff leaderboard (AC: #1, #2, #3)
  - [ ] Satisfy AC#1: Per-staff totals, count of services, average ticket.
  - [ ] Satisfy AC#2: Filterable by role (stylist / instructor / attendant).
  - [ ] Satisfy AC#3: Click → per-staff drill-down with commission totals.
- [ ] Task 2: Tests (AC: all)
